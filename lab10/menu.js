const menuList = [
    ...
    },
    {
      ...
      desc: `Best vaffeles in the town, you will want more.`,
    },
    {
      id: 13,
      ...
      category: "desserts",
      price: 10.00,
      img: "./images/item-13jpg.jpg",
      desc: `chocolate, only chocolite, be reaady.`,
    },
  ];
...
function displayItems(itemsArry) {
  let displayMenu = itemsArry.map((item)=> {
    return `<div class="menu-item-col">
...
{
  const categories = menuList.reduce((values, item) => {
